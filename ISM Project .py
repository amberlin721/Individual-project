...
#Histogram graph, show the relationship between gender and cars sold
...
#Histogram graph, show the relationship between sales training and cars sold
...
#scatter spot graph, x for years experience, y for hours worked
...
#scatter spot graph, x for cars sold, y for houe worked
...
#Bar graph, bar plot with axis titles
